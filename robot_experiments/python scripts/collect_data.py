...
class RobotReader():
	...
	def save_data(self):
		...
		print("1: ", self.robot_joint.shape)
		print("2: ", self.robot_joint_vel.shape)
		print("3: ", self.robot_pose.shape)
		...
		"ee_T_13", "ee_T_23", "ee_T_33", "v_x", "v_y", "w_z", "time"]
		...
		self.folder = str('/home/kiyanoush/Cpp_ws/src/robotTest2/data/2dof_trapezoid/data_sample_' + datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))
