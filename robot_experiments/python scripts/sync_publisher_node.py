...
def sync_publisher(tactile_data, robot_state_data, slip_onset_data, marker_data):
			...
			sync_data_vec[48:71, 0] = robot_state_data.data
			sync_data_vec[71:78, 0] = [marker_data.pose.position.x, marker_data.pose.position.y, marker_data.pose.position.z,
			...
			sync_data_vec[78:, 0] = slip_onset_data.data
